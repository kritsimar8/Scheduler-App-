...
Color strenghtenolor (Color color, double factor){
...
String rgbToHex(Color color){
  return '${color.red.toRadixString(16).padLeft(1,'0')}${color.green.toRadixString(16).padLeft(2,'0')}${color.blue.toRadixString(16).padLeft(2,'0')}';
}
